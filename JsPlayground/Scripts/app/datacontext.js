define('datacontext',
    ...
    function ($, _, ko, model, modelmapper, dataservice, config, utils) {
        var logger = config.logger,
            ...
            awesome = new EntitySet(dataservice.awesome.getData, modelmapper.awesome, model.Awesome.Nullo);

        awesome.getAwesomeData = function(options) {
            return $.Deferred(function (def) {
                _.extend(options, {
                    getFunctionOverride: dataservice.awesome.getAwesomeData
                });

                $.when(awesome.getData(options))
